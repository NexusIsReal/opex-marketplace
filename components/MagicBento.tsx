          ...
          {cards.map((card, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="card-content flex flex-col h-full justify-between z-10 relative">
                  <div>
                    {card.icon ? (
                      <div className="flex items-center justify-center mb-3 text-[#9945FF] transform group-hover:scale-110 transition-all duration-300">
                        {card.icon}
                      </div>
                    ) : (
                      <>
                        <div className="card-label text-xs font-medium mb-1 opacity-70">
                          {card.label}
                        </div>
                        <h3 className="card-title text-lg font-bold mb-1">{card.title}</h3>
